    ...
    render={(data) => (
      <Grid name="fellowparsons">
        ...
        <Content column="10 / span 3" inverted row="7 / span 4">
          <p>
            Dr. Burk Parsons is senior pastor of Saint Andrew’s Chapel in
          ...
          <p>
            Dr. Parsons began serving at Ligonier Ministries in 1999, and he
            became a teaching fellow in 2017. Dr. Parsons is a wise and
            discerning voice, and he helps maintain Ligonier’s theological
            fidelity and advance Ligonier’s service to the church. He has
            recorded a teaching series with Ligonier called{' '}
            <em>The Great Commission</em>, and he is author of{' '}
            <em>Why Do We Have Creeds?</em> He is editor of{' '}
            <em>Assured by God</em> and{' '}
            <em>John Calvin: A Heart for Devotion, Doctrine, and Doxology</em>{' '}
            and coeditor and cotranslator of{' '}
            <em>A Little Book on the Christian Life</em> by John&nbsp;Calvin.
          </p>
        </Content>
      </Grid>
    )}
