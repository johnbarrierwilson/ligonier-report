...
const IndexPage = () => (
  <Grid name="listen02">
    ...
    >
      <p>The Ligonier App is a daily gospel resource that provides instant access to a deep library of Christian teaching. It puts trustworthy teaching in the palm of your hand, gathering together daily audio, video, devotional arti- cles, and much more.</p>
