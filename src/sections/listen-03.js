...
const IndexPage = () => (
  <Grid name="listen03">
    ...
    >
      <p>Ligonier teaching resources can now be accessed in more ways than ever. Whether it’s video or audio, trusted Bible teaching is available wher- ever you like to tune in—YouTube, Amazon Prime Video, Alexa, and Roku.</p>
    ...
    <Well size="l" top={true}>
      ...
      >
        <p>Our featured podcasts provide spiritual food for growing Christians wherever they are. 5 Minutes in Church History, with Stephen Nichols, travels back in time to explore the lives of the saints who came before us and the events which shaped their journey.</p>
